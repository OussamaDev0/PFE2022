...
$get_order = "select * from commande WHERE com_status='pending' order by 1 DESC LIMIT 0,5";
$run_order = mysqli_query($con,$get_order);

while($row_order=mysqli_fetch_array($run_order)){


$order_id = $row_order['id_commande'];

$c_id = $row_order['user_id'];

$invoice_no = $row_order['facteur_no'];
...
$order_status = $row_order['com_status'];
...
<td><a href="order_confirm.php?OrderId=<?php echo $order_id ?>"><i class="fa fa-check"></i> Confirmer</a></td>
</tr>
