...
$edit_p_cat_query = "select * from categorie_prod where id_cat='$edit_p_cat_id'";

$run_edit = mysqli_query($con,$edit_p_cat_query);

$row_edit = mysqli_fetch_array($run_edit);

$p_cat_id = $row_edit['id_cat'];

$p_cat_title = $row_edit['cat_libelle'];
...
$update_p_cat = "update categorie_prod set cat_libelle='$p_cat_title' where id_cat='$p_cat_id'";
