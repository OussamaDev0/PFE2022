            ...
            <div class="container large-right-sider">
                <div class="row pt-5 hide-front-page">
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6  text-center">
                        <a href="logged_in_for-each-image.php#\"><img src="Images/girl.jpg" class="img-men" data-aos="fade-up" style="border-radius:20px;height:180px"></a>
                        <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">tradesional dress<br>303MAD</span></a>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6  text-center">
                        ...
                        <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">pink saree<br>232MAD</span></a>
                    </div>
                ...
                <div class="row pt-5 hide-front-page">
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6  text-center">
                        <a href="logged_in_for-each-image.php#\"><img src="Images/men-1.jpg" class="img-men" data-aos="fade-up" style="border-radius:20px;height:180px"></a>
                        <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">accessories dress<br>340MAD</span></a>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6  text-center">
                        <a href="logged_in_for-each-image.php#\"><img src="Images/blazers.jpg" class="img-men" data-aos="fade-up" style="height:180px"><br></a>
                        <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">black shirt<br>210MAD</span></a>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-tablate">
                        <a href="logged_in_for-each-image.php#\"><img src="Images/men-1.jpg" class="img-men" data-aos="fade-up" style="border-radius:20px;height:180px"></a>
                        <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">accessories dress<br>340MAD</span></a>
                ...
                <div class="row pt-5 hide-front-page">
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6  text-center">
                        ...
                        <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">toddler dress<br>150MAD</span></a>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6  text-center">
                        ...
                        <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">flower print shirt<br>335MAD</span></a>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-tablate">
                        <a href="logged_in_for-each-image.php#\"><img src="Images/kids.jpg" class="img-men" data-aos="fade-up" style="border-radius:20px;height:180px"></a>
                        <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">toddler dress<br>150MAD</span></a>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 text-center hide-containt-small-device">
                        <a href="logged_in_for-each-image.php#\"><img src="Images/boys-kids.jpg" class="img-men" data-aos="fade-up" style="border-radius:20px;height:180px"></a>
                        <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">flower print shirt<br>335MAD</span></a>
                    </div>
                </div>
                ...
                <div class="row pt-5 pb-5 hide-front-page">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6  text-center">
                        <a href="logged_in_for-each-image.php#\"><img src="Images/kids.jpg" class="img-men" data-aos="fade-up" style="border-radius:20px;height:180px"><br></a>
                        <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">toddler dress<br>150MAD</span></a>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-tablate">
                        <a href="logged_in_for-each-image.php#\"><img src="Images/blazers.jpg" class="img-men" data-aos="fade-up" style="border-radius:20px;height:180px"><br></a>
                        <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">black shirt<br>340MAD</span></a>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 text-center hide-containt-small-device">
                        <a href="logged_in_for-each-image.php#\"><img src="Images/boys-kids.jpg" class="img-men" data-aos="fade-up" style="border-radius:20px;height:180px"></a>
                        <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">flower print shirt<br>335MAD</span></a>
                ...
                <div class="container show-two-hundred-page">
                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/kids-dress-1.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/ladies-dress-2.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>170MAD</span></a>
                        </div>
                    </div>
                    <!--second row-->
                    <div class="row pt-5">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            ...
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>126MAD</span></a>
                        </div>
                    </div>
                    <!--third row-->
                    <div class="row pt-5">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            ...
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>187MAD</span></a>
                        </div>
                    </div>
                    <!--fourth row-->
