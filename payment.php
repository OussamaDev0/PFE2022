...
<div class="container-fluid text-white" id="change-color">
    <div class="row" id="top-containt">
        ...
        <div class="col-8 pt-4 mt-1 text-center">
            ...
            <ul class="dropdown-menu mt-4 text-center" style="margin-left:-6%;border-radius:10px;">
                ...
                <li class="pre-profile-1 pt-2 pb-2"><a href="ecommerce.php" class="color" style="font-weight:600">Log In</a></li>
            </ul>
    ...
    <div class="container-fluid side-bar px-0">
        ...
        <ul class="pt-5 pre-side-bar">
            <li class="pt-4" style="margin-left:-5%;"><a href="login-ecomarce.php" class="color">home</a></li>
            ...
            <li class="pt-3"style="margin-left:-5%"><a href="ecomarce.php" class="color">Log In</a><span><a href="#" class="color"><img src="log-in..png" class="log-in"></a></span></li>
        </ul>
    </div>
</div>
<!--header part end-->
