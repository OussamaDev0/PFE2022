...
<div class="container-fluid text-white" id="change-color">
    <div class="row" id="top-containt">
        <div class="col-4 text-center">
            <br><br> <a href="login-ecommerce.php"><img src="Images/shopping-logo.png" style="width:100px;height:100px;" class="color logo-1 logo-sift"></a>
        ...
        <div class="col-8 pt-4 mt-1 text-center">
            ...
            <ul class="dropdown-menu mt-4 text-center" style="margin-left:-6%;border-radius:10px;">
                ...
                <li class="pre-profile-1 pt-2 pb-2"><a href="ecommerce.php" class="color" style="font-weight:600">Log Out</a></li>
            </ul>
            <span class="menu-1"><a href="login-ecommerce.php" class="color">home</a></span>
            <span class="menu"><a href="Logged_in_product_page.php" class="color">products</a></span>
            <span class="menu"><a href="logged_in_about_us.php" class="color">about</a></span>
    ...
    <div class="container-fluid side-bar px-0">
        ...
        <ul class="pt-5 pre-side-bar">
            <li class="pt-4" style="margin-left:-5%;"><a href="login-ecommerce.php" class="color">home</a></li>
            <li class="pt-3"style="margin-left:-5%"><a href="Logged_in_product_page.php" class="color">products</a></li>
            <li class="pt-3"style="margin-left:-5%"><a href="logged_in_about_us.php" class="color">about</a></li>
            ...
            <li class="pt-3"style="margin-left:-5%"><a href="ecommerce.php" class="color">log out</a><span><a href="#" class="color"><img src="Images/log-in..png" class="log-in"></a></span></li>
        </ul>
    </div>
</div>
<!--header part end-->
            ...
            <div class="container large-right-sider">
                ...
                <div class="row pt-5 hide-front-page">
                    <?php while($produit=$ps->fetch()) { ?>
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6  text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="productimages/<?php echo($produit['prod_img']);?>" class="img-men" data-aos="fade-up" style="border-radius:20px;height:180px"></a><br>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up"><?php echo($produit['prod_nom']); ?><br>&#8377;<?php echo($produit['prod_prix']); ?></span></a>
                        </div>
                    <?php } ?>
                </div>
                ...
                <div class="container show-two-hundred-page">
                    ...
                    <div class="row pt-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            ...
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;130.00</span></a>
                        </div>
                    </div>
                    <!--second row-->
                    <div class="row pt-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/kids-dress-2.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            ...
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;100.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            ...
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;135.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/mens-dress-3.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;126.00</span></a>
                        </div>
                    </div>
                    <!--third row-->
                    <div class="row pt-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            ...
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;155.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            ...
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;176.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/boys-dress-1.jpeg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;133.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/boys-dress-2.jpeg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;187.00</span></a>
                        </div>
                    </div>
                    <!--fourth row-->
                    <div class="row pt-5 pb-5">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/ladies-dress-1.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;120.00</span></a>
                        </div>
                    </div>
                ...
                <div class="container show-three-hundred-page">
                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/two-hundred-ladies.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;120.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/two-hundred.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;.150.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/two-hundred-girls.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;170.00</span></a>
                        </div>
                    </div>
                    <!--second row-->
                    <div class="row pt-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/two-hundred-men.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/two-hundred-men-1.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;126.00</span></a>
                        </div>
                    </div>
                    <!--third row-->
                    <div class="row pt-5">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/two-hundred-men-2.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;133.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/two-hundred-boys-1.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;187.00</span></a>
                        </div>
                    </div>
                    <!--fourth row-->
                    <div class="row pt-5 pb-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/two-hundred-men-3.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;100.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/two-hundred-ladies-3.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;135.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/two-hundred-men-4.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/two-hundred-girls-2.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;120.00</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="container show-four-hundred-page">
                    ...
                    <div class="row pt-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-boys.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress2<br>&#8377;130.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-men.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;120.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-ladies.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;.150.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-girls.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;170.00</span></a>
                        </div>
                    </div>
                    <!--second row-->
                    <div class="row pt-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-men-1.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-ladies-1.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;100.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-boys-1.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;135.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-men-2.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;126.00</span></a>
                        </div>
                    </div>
                    <!--third row-->
                    <div class="row pt-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-ladies-2.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;155.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-men-3.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;176.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-boys-2.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;133.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-men-4.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\/"><span class="image-lable">tradesional dress<br>&#8377;187.00</span></a>
                        </div>
                    </div>
                    <!--fourth row-->
                    <div class="row pt-5 pb-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-girls-1.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;100.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-ladies-3.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;135.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-men-5.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/three-hundred-men-6.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;120.00</span></a>
                        </div>
                    </div>
                ...
                <div class="container show-five-hundred-page">
                    ...
                    <div class="row pt-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-men.jpeg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;130.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-boys.jpeg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;120.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-men-1.jpeg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;.150.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-girls.jpeg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;170.00</span></a>
                        </div>
                    </div>
                    <!--second row-->
                    <div class="row pt-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-boys-1.jpeg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-ladies.jpeg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;100.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-men-2.jpeg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;135.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-boys-2.jpeg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;126.00</span></a>
                        </div>
                    </div>
                    <!--third row-->
                    <div class="row pt-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-girls-1.jpeg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;155.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-men-3.jpeg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;176.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-men-4.jpeg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;133.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-ladies-1.jpeg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;187.00</span></a>
                        </div>
                    </div>
                    <!--fourth row-->
                    <div class="row pt-5 pb-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-men-5.jpeg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;100.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-ladies-2.jpeg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;135.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-men-6.jpeg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/four-hundred-boys-3.jpeg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;120.00</span></a>
                        </div>
                    </div>
                ...
                <div class="container show-six-hundred-page">
                    ...
                    <div class="row pt-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-men.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;130.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-boys.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;120.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-men-1.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;.150.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-girls.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;170.00</span></a>
                        </div>
                    </div>
                    <!--second row-->
                    <div class="row pt-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-men-2.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-boys-1.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;100.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-ladies.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;135.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-girls-1.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;126.00</span></a>
                        </div>
                    </div>
                    <!--third row-->
                    <div class="row pt-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-girls-2.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;155.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-men-3.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;176.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-men-4.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;133.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-boys-2.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;187.00</span></a>
                        </div>
                    </div>
                    <!--fourth row-->
                    <div class="row pt-5 pb-5">
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-girls-3.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;100.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-men-5.jpg" class="img-men" style="border-radius:20px;height:180px"><br></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;135.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-girls-4.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-4 text-center hide-containt-small-device">
                            <a href="logged_in_for-each-image.php#\"><img src="Images/five-hundred-men-6.jpg" class="img-men" style="border-radius:20px;height:180px"></a>
                            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;120.00</span></a>
                        </div>
                    </div>
                </div>
...
<div class="container mt-5 pt-2 for-small-devices">
    <div class="row">
        <div class="col-md-4 col-sm-6 col-12 text-center pb-5">
            ...
            <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">tradesional dress<br>&#8377;150.00</span></a>
        </div>
        <div class="col-md-4 col-sm-6 col-12 text-center">
            ...
            <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">tradesional dress<br>&#8377;120.00</span></a>
        </div>
        <div class="col-md-4 col-sm-6 col-12 text-center hide-content">
            ...
            <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">tradesional dress<br>&#8377;180.00</span></a>
        </div>
    </div>
    <!--second row-->
    <div class="row pt-5">
        <div class="col-md-4 col-sm-6 col-12 text-center pb-5">
            ...
            <a href="logged_in_for-each-image.php#\"><span class="image-lable" data-aos="fade-up">tradesional dress<br>&#8377;100.00</span></a>
        </div>
        <div class="col-md-4 col-sm-6 col-12 text-center">
    ...
    <div class="container show-three-hundred-small-page">
        ...
        <div class="row pt-5">
            ...
            <div class="col-md-4 col-sm-6 col-12 text-center hide-content">
                ...
                <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;133.00</span>
            </div>
        </div>
    </div>
    ...
    <div class="container show-four-hundred-small-page">
        ...
        <div class="row pt-5">
            <div class="col-md-4 col-sm-6 col-12 text-center pb-5">
                ...
                <a href="logged_in_for-each-image.php#\"></a><span class="image-lable">tradesional dress<br>&#8377;130.00</span></a>
            </div>
            <div class="col-md-4 col-sm-6 col-12 text-center">
                ...
                <a href="logged_in_for-each-image.php#\"></a><span class="image-lable">tradesional dress<br>&#8377;120.00</span></a>
            </div>
            <div class="col-md-4 col-sm-6 col-12 text-center hide-content">
                ...
                <a href="logged_in_for-each-image.php#\"></a><span class="image-lable">tradesional dress<br>&#8377;.150.00</span></a>
            </div>
        </div>
        <!--second row-->
        <div class="row pt-5">
            <div class="col-md-4 col-sm-6 col-12 text-center pb-5">
                ...
                <a href="logged_in_for-each-image.php#\"></a><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
            </div>
            <div class="col-md-4 col-sm-6 col-12 text-center">
                ...
                <a href="logged_in_for-each-image.php#\"></a><span class="image-lable">tradesional dress<br>&#8377;100.00</span></a>
            </div>
            <div class="col-md-4 col-sm-6 col-12 text-center hide-content">
                ...
                <a href="logged_in_for-each-image.php#\"></a><span class="image-lable">tradesional dress<br>&#8377;135.00</span></a>
            </div>
        </div>
        <!--third row-->
        <div class="row pt-5">
            <div class="col-md-4 col-sm-6 col-12 text-center pb-5">
                ...
                <a href="logged_in_for-each-image.php#\"></a><span class="image-lable">tradesional dress<br>&#8377;155.00</span></a>
            </div>
            <div class="col-md-4 col-sm-6 col-12 text-center">
                ...
                <a href="logged_in_for-each-image.php#\"></a><span class="image-lable">tradesional dress<br>&#8377;176.00</span></a>
            </div>
            <div class="col-md-4 col-sm-6 col-12 text-center hide-content">
                ...
                <a href="logged_in_for-each-image.php#\"></a><span class="image-lable">tradesional dress<br>&#8377;133.00</span></a>
            </div>
        </div>
    </div>
...
<div class="container" style="height:80vh">
    <div class="row">
        <div class="col-sm-12 text-center pt-5">
            <a href="logged_in_for-each-image.php#\"><span style="text-transform: uppercase;font-weight: 700;font-size:30px;">recommend</span></a>
        </div>
    </div>
    <div class="row single-slider pt-5">
        <div class="col text-center">
            <a href="logged_in_for-each-image.php#\"><span style="display:flex;justify-content: center;"><img src="Images/boys-dress-1.jpeg" height="250px" style="background-color:black"></span></a>
            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
        </div>
        <div class="col  text-center">
            <a href="logged_in_for-each-image.php#\"><span style="display:flex;justify-content: center;"><img src="Images/mens-dress-2.jpg" height="250px"></span></a>
            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
        </div>
        <div class="col  text-center">
            <a href="logged_in_for-each-image.php#\"><span style="display:flex;justify-content: center;"><img src="Images/ladies-dress-1.jpg" height="250px"></span></a>
            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
        </div>
        <div class="col text-center">
            <a href="logged_in_for-each-image.php#\"><span style="display:flex;justify-content: center;"><img src="Images/mens-dress-4.jpg" height="250px"></span></a>
            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
        </div>
        <div class="col  text-center">
            <a href="logged_in_for-each-image.php#\"><span style="display:flex;justify-content: center;"><img src="Images/ladies-dress-2.jpg" height="250px"></span></a>
            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
        </div>
        <div class="col text-center">
            <a href="logged_in_for-each-image.php#\"><span style="display:flex;justify-content: center;"><img src="Images/mens-dress-3.jpg" height="250px"></span></a>
            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
        </div>
        <div class="col  text-center">
            <a href="logged_in_for-each-image.php#\"><span style="display:flex;justify-content: center;"><img src="Images/ladies-dress-3.jpg" height="250px"></span></a>
            <a href="logged_in_for-each-image.php#\"><span class="image-lable">tradesional dress<br>&#8377;180.00</span></a>
        </div>
    </div>
</div>
